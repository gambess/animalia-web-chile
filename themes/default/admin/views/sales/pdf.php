    ...
    $base64 = 'data:image/' . $type . ';base64,' . base64_encode($data); ?>
            ...
            <div class="padding10">
                ...
                <div class="col-xs-5">
                    ...
                    <h2 class=""><?= ucwords(strtolower($customer->name));/*$customer->company && $customer->company != '-' ? $customer->company : $customer->name;*/ ?></h2>
                    <?= $customer->company && $customer->company != '-' ? '' : /*'Attn: '.*/  $customer->company; ?>
                    <?php
                        echo $customer->address . '<br />'.lang('tel') . ': ' . $customer->phone . '<br />' . $customer->city . ' - ' . $customer->country;
                        echo '<p>';
                        ...
                        echo '</p><br />';
                        //echo lang('tel') . ': ' . $customer->phone . '<br />' . lang('email') . ': ' . $customer->email.'</br>';

                        echo $inv->payment_status=='due' || $inv->payment_status =='pending' ? 'Metodo de pago: Pendiente</br>' :'Metodo de pago: '.$payments[0]->tipo_pago .'<br>';
                        echo  $inv->payment_status=='due' || $inv->payment_status =='pending' ? 'Tipo de venta: '.$inv->sell_type : 'Tipo de venta: '.$payments[0]->tipo_venta.'<br>';
                ...
                <div class="col-xs-5">
                    ...
                    <?php
                        //echo $biller->address . '<br />'.lang('tel') . ': ' . $biller->phone . '<br />' . $biller->city . ' ' . $biller->postal_code .'<br />' . $biller->country;
                        echo $biller->address . '<br />'.lang('tel') . ': ' . $biller->phone . '<br />'. $biller->city. ' - ' .$biller->country ;
                        echo '<p>';
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-xs-4 pull-left">
                    <p style="height: 80px;"><?= lang('seller'); ?>
                        : <?= $inv->created_by ? $user->first_name . ' ' . $user->last_name : $customer->name; ?> </p>
                    <hr>
                    <p><?= lang('stamp_sign'); ?></p>
                </div>
                <div class="col-xs-4 pull-right">
                    <p style="height: 80px;"><?= lang('customer'); ?>
                        : <?= ucwords(strtolower($customer->name))//$customer->company ? $customer->company : $customer->name; ?> </p>
                    <hr>
                    <p><?= lang('stamp_sign'); ?></p>

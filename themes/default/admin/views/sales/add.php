                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col col-md-4">
                            <div class="form-group">
                                <?=lang("Tipo venta", "paying_actions_1");?>
                                <select name="paying_actions" id="paying_actions_1" class="form-control paid_by">

                                    <?php foreach ($paying_actions as $type) { ?>
                        ...
                        <div class="col-md-12">
                            <div
                                class="form-group"><?php echo form_submit('add_sale', lang("submit"), 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#slcustomer').change(function() {
            ...
            $.ajax({
                type: 'get',
                url: '<?= admin_url('sales/getLastSale'); ?>',
                dataType: "json",
                data: {
                    customer: id
                },
                success: function (data) {
                    for (var i = 0; i < data.length; i++) {
                        var row = add_invoice_item(data[i]);
                    }
                }
            });
        });

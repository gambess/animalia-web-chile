                            ...
                            <div id="left-bottom">
                                ...
                                <div id="payment-con">
                                    <?php for ($i = 1; $i <= 5; $i++) {?>
                                        ...
                                        <input type="hidden" name="paid_by[]" id="paid_by_val_<?=$i?>" value="1"/>
                                ...
                                <input type="hidden" name="rpaidby" id="rpaidby" value="1" style="display: none;"/>
                            ...
                            <div class="well well-sm well_1">
                                <div class="payment">
                                    <div class="row">
                                        ...
                                        <!--<div class="col-sm-4">
                                            <div class="form-group">
                                                <?=lang("product_discount", "paid_by_2");?>
                                                <input name="discount_2" type="text" id="discount_2"

...
function update_cart_item(t, e, s, a, i) {
    $.ajax({url: t, type: "POST", data: e, success: function (t) {
...
function gen_html(t) {
    ...
    if (t || (e += '<div class="col-sm-12"><div class="alert alert-warning text-center padding-xl margin-top-lg"><h4 class="margin-bottom-no">' + lang.x_product + "</h4></div></div>"), 1 == site.settings.products_page && ($("#results").empty(), $(".grid").isotope("destroy").isotope()), $.each(t, function (s, r) {
        var n = r.special_price ? r.special_price : r.price, l = r.special_price ? r.formated_special_price : r.formated_price, c = (r.promotion && r.promo_price && 0 != r.promo_price ? r.promo_price : n, r.promotion && r.promo_price && 0 != r.promo_price ? r.formated_promo_price : l);
...
function searchProducts() {
    $("#loading").show();
    var t = {};
    t[site.csrf_token] = site.csrf_token_value, t.filters = get_filters(), t.format = "json", $.ajax({url: site.shop_url + "search?page=" + filters.page, type: "POST", data: t, dataType: "json"}).done(function (t) {
...
function update_mini_cart(t) {
    if (t.total_items && t.total_items > 0) {
        ...
        $(".cart-total-items").text(lang.cart_empty), $("#cart-contents").hide(), $("#cart-empty").show()
}
function update_cart(t) {
    if (t.total_items && t.total_items > 0) {
        ...
        $("#total-items").text(t.total_items), $(".cart-contents").hide(), $(".cart-empty-msg").show()
}
...
function saa_alert(t, e, s, a) {
    s = s || "delete", e = e || "This action can't be reverted back.", a = a || {}, a._method = s, a[site.csrf_token] = site.csrf_token_value, swal({title: "Are you sure?", html: e, type: "question", showCancelButton: !0, allowOutsideClick: !1, showLoaderOnConfirm: !0, preConfirm: function () {
            return new Promise(function () {
                $.ajax({url: t, type: "POST", data: a, success: function (t) {
...
function prompt(t, e, s) {
    t = t || "Reset Password", e = e || "Please type your email address", s = s || {}, s[site.csrf_token] = site.csrf_token_value, swal({title: t, html: e, input: "email", showCancelButton: !0, allowOutsideClick: !1, showLoaderOnConfirm: !0, confirmButtonText: lang.submit, preConfirm: function (t) {
            return s.email = t, new Promise(function (t, e) {
                $.ajax({url: site.base_url + "forgot_password", type: "POST", data: s, success: function (s) {
                        s.status ? t(s) : e(s)
                    }, error: function () {
                        sa_alert("Error!", "Ajax call failed, please try again or contact site owner.", "error", !0)
                    }})
...
function add_address(t) {
    ...
    swal({title: t.id ? lang.update_address : lang.add_address, html: '<span class="text-bold padding-bottom-md">' + lang.fill_form + '</span><hr class="swal2-spacer padding-bottom-xs" style="display: block;"><form action="' + site.shop_url + 'address" id="address-form" class="padding-bottom-md"><input type="hidden" name="' + site.csrf_token + '" value="' + site.csrf_token_value + '"><div class="row"><div class="form-group col-sm-12"><input name="line1" id="address-line-1" value="' + (t.line1 ? t.line1 : "") + '" class="form-control" placeholder="Line 1"></div></div><div class="row"><div class="form-group col-sm-12"><input name="line2" id="address-line-2" value="' + (t.line2 ? t.line2 : "") + '" class="form-control" placeholder="Line 2"></div></div><div class="row"><div class="form-group col-sm-6"><input name="city" value="' + (t.city ? t.city : "") + '" id="address-city" class="form-control" placeholder="City"></div><div class="form-group col-sm-6" id="istates">' + e + '</div><div class="form-group col-sm-6"><input name="postal_code" value="' + (t.postal_code ? t.postal_code : "") + '" id="address-postal-code" class="form-control" placeholder="Postal Code"></div><div class="form-group col-sm-6"><input name="country" value="' + (t.country ? t.country : "") + '" id="address-country" class="form-control" placeholder="Country"></div><div class="form-group col-sm-12 margin-bottom-no"><input name="phone" value="' + (t.phone ? t.phone : "") + '" id="address-phone" class="form-control" placeholder="Phone"></div></form></div>', showCancelButton: !0, allowOutsideClick: !1, confirmButtonText: lang.submit, preConfirm: function () {
            ...
            if ($("#address-line-1").val(t.line1 ? t.line1 : "").focus(), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent))
                ...
                for (var e = document.querySelectorAll(".mobile-device"), s = 0; s < e.length; s++)
                    e[s].classList.remove("mobile-device");
                $(".selectpickerstate").selectpicker({size: 5}), $(".selectpickerstate").selectpicker("val", t.state ? t.state : "")
            }
        }}).then(function (e) {
        var s = $("#address-form");
        $.ajax({url: s.attr("action") + (t.id ? "/" + t.id : ""), type: "POST", data: s.serialize(), success: function (t) {
...
function email_form() {
    swal({title: lang.send_email_title, html: '<div><span class="text-bold padding-bottom-md">' + lang.fill_form + '</span><hr class="swal2-spacer padding-bottom-xs" style="display: block;"><form action="' + site.shop_url + 'send_message" id="message-form" class="padding-bottom-md"><input type="hidden" name="' + site.csrf_token + '" value="' + site.csrf_token_value + '"><div class="row"><div class="form-group col-sm-12"><input type="text" name="name" id="form-name" value="" class="form-control" placeholder="Full Name"></div></div><div class="row"><div class="form-group col-sm-12"><input type="email" name="email" id="form-email" value="" class="form-control" placeholder="Email"></div></div><div class="row"><div class="form-group col-sm-12"><input type="text" name="subject" id="form-subject" value="" class="form-control" placeholder="Subject"></div></div><div class="row"><div class="col-sm-12"><textarea name="message" id="form-message" class="form-control" placeholder="Message" style="height:100px;"></textarea></div></div></form></div>', showCancelButton: !0, allowOutsideClick: !1, confirmButtonText: lang.submit, preConfirm: function () {
        ...
        var e = $("#message-form");
        $.ajax({url: e.attr("action"), type: "POST", data: e.serialize(), success: function (t) {
...
$(function () {
    if ($(document).on("click", ".add-to-cart", function (t) {
        t.preventDefault();
        var e = $(this).attr("data-id"), s = $(".shopping-cart:visible"), a = $(this).parents(".product-bottom").find(".quantity-input"), i = $(this).parents(".product").find("img").eq(0);
        if (i) {
            var o = i.clone().offset({top: i.offset().top, left: i.offset().left}).css({opacity: "0.5", position: "absolute", height: "150px", width: "150px", "z-index": "1000"}).appendTo($("body")).animate({top: s.offset().top + 10, left: s.offset().left + 10, width: "50px", height: "50px"}, 400);
    ...
    }), $(".tip").tooltip({container: "body"}), $(".validate").formValidation({framework: "bootstrap", message: "This value is required or not valid"}), $(window).scroll(function () {
    ...
    if ($(".theme-color").click(function (t) {
        ...
        update_mini_cart(cart), update_cart(cart), $(document).on("click", ".remove-item", function (t) {
            t.preventDefault();
            var e = {};
            ...
            t.preventDefault();
            var e = this.defaultValue, s = $(this).closest("tr"), a = s.attr("id"), i = site.site_url + "cart/update", o = {};
        ...
        $('[data-target="#lightbox"]').on("click", function (t) {
            var e = $(this).find("img"), a = e.attr("src"), i = e.attr("alt"), o = {maxWidth: $(window).width() - 10, maxHeight: $(window).height() - 10};

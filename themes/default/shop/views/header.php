...
<html>
    <head>
        ...
        <link href="<?= $assets; ?>css/bootstrap.3.3.7.css" rel="stylesheet"><!-- from styles --> 
        <link href="<?= $assets; ?>css/rrss-buttons.css" rel="stylesheet">
        <link href="<?= $assets; ?>css/swal.css" rel="stylesheet">
        <link href="<?= $assets; ?>css/font-awesome.4.7.0.css" rel="stylesheet">
        <link href="<?= $assets; ?>css/form-validation.css" rel="stylesheet">
        <link href="<?= $assets; ?>css/bootstrap-select.1.11.2.css" rel="stylesheet">
         <!-- end new libs --> 
         
         <!-- new styles --> 
        <link href="<?= $assets; ?>css/theming.css" rel="stylesheet">

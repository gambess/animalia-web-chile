            ...
            <div class="col-lg-6">
                <div class="product" style="z-index: 1;">
                    <div class="details" style="transition: all 100ms ease-out 0s;">
                        <img src="http://play.animaliaweb.cl/assets/uploads/no_image.png" alt="">
                        <div class="image_overlay"></div>
                        <div class="btn add-to-cart" data-id="1841"><i class="fa fa-shopping-cart"></i> Añadir a la cesta</div>
                        <div class="stats-container">
                            <span class="product_price">
                                24.590$                                                        </span>
                            <span class="product_name">
                                <a href="http://play.animaliaweb.cl/product/master-dog-adulto-carne-18kg">MD Adulto Carne 18Kg</a>
                            </span>
                            <a href="http://play.animaliaweb.cl/category/alimentos" class="link">Alimentos</a>
                            <span class="link">-</span>
                            <a href="http://play.animaliaweb.cl/brand/master-dog" class="link">Master Dog</a>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="product" style="z-index: 1;">
                    <div class="details" style="transition: all 100ms ease-out 0s;">
                        <img src="http://play.animaliaweb.cl/assets/uploads/no_image.png" alt="">
                        <div class="image_overlay"></div>
                        <div class="btn add-to-cart" data-id="2242"><i class="fa fa-shopping-cart"></i> Añadir a la cesta</div>
                        <div class="stats-container">
                            <span class="product_price">
                                9.490$                                                        </span>
                            <span class="product_name">
                                <a href="http://play.animaliaweb.cl/product/arena-tidy-cats-272kg">Arena Tidy Cats 2.7Kg</a>
                            </span>
                            <a href="http://play.animaliaweb.cl/category/arenas-sanitarias" class="link">Arenas Sanitarias</a>
                            <span class="link">-</span>
                            <a href="http://play.animaliaweb.cl/brand/tidy-cats" class="link">Tidy Cats</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
            ...
            <div class="col-lg-6">
                <div class="product" style="z-index: 1;">
                    <div class="details" style="transition: all 100ms ease-out 0s;">
                        <img src="http://play.animaliaweb.cl/assets/uploads/no_image.png" alt="">
                        <div class="image_overlay"></div>
                        <div class="btn add-to-cart" data-id="2262"><i class="fa fa-shopping-cart"></i> Añadir a la cesta</div>
                        <div class="stats-container">
                            <span class="product_price">
                                1.100$                                                        </span>
                            <span class="product_name">
                                <a href="http://play.animaliaweb.cl/product/dentastix-ad-rm-3u-77g">Dentastix Ad RM 3u 77g</a>
                            </span>
                            <a href="http://play.animaliaweb.cl/category/higienie-y-salud" class="link">Higiene y Salud</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
            ...
            <div class="col-lg-6">
                <div class="product" style="z-index: 1;">
                    <div class="details" style="transition: all 100ms ease-out 0s;">
                        <img src="http://play.animaliaweb.cl/assets/uploads/no_image.png" alt="">
                        <div class="image_overlay"></div>
                        <div class="btn add-to-cart" data-id="2267"><i class="fa fa-shopping-cart"></i> Añadir a la cesta</div>
                        <div class="stats-container">
                            <span class="product_price">
                                1.990$                                                        </span>
                            <span class="product_name">
                                <a href="http://play.animaliaweb.cl/product/dentastix-ad-rm-7u-180g">Dentastix Ad RM 7u 180g</a>
                            </span>
                            <a href="http://play.animaliaweb.cl/category/higienie-y-salud" class="link">Higiene y Salud</a>
                        </div>
                        <div class="clearfix"></div>
            ...
            <div class="col-lg-6">
                <div class="product" style="z-index: 1;">
                    <div class="details" style="transition: all 100ms ease-out 0s;">
                        <img src="http://play.animaliaweb.cl/assets/uploads/no_image.png" alt="">
                        <div class="image_overlay"></div>
                        <div class="btn add-to-cart" data-id="2407"><i class="fa fa-shopping-cart"></i> Añadir a la cesta</div>
                        <div class="stats-container">
                            <span class="product_price">
                                1.990$                                                        </span>
                            <span class="product_name">
                                <a href="http://play.animaliaweb.cl/product/arena-topk9-ecologica-2kg">Arena Topk9 Ecológica 2kg</a>
                            </span>
                            <a href="http://play.animaliaweb.cl/category/arenas-sanitarias" class="link">Arenas Sanitarias</a>
                            <span class="link">-</span>
                            <a href="http://play.animaliaweb.cl/brand/topk9" class="link">Topk9</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
            ...
            <div class="col-lg-6">
                <div class="product" style="z-index: 1;">
                    <div class="details" style="transition: all 100ms ease-out 0s;">
                        <img src="http://play.animaliaweb.cl/assets/uploads/no_image.png" alt="">
                        <div class="image_overlay"></div>
                        <div class="btn add-to-cart" data-id="2168"><i class="fa fa-shopping-cart"></i> Añadir a la cesta</div>
                        <div class="stats-container">
                            <span class="product_price">
                                8.990$                                                        </span>
                            <span class="product_name">
                                <a href="http://play.animaliaweb.cl/product/arena-tidy-cats-9kg">Arena Tidy Cats 9Kg</a>
                            </span>
                            <a href="http://play.animaliaweb.cl/category/arenas-sanitarias" class="link">Arenas Sanitarias</a>
                            <span class="link">-</span>
                            <a href="http://play.animaliaweb.cl/brand/tidy-cats" class="link">Tidy Cats</a>
